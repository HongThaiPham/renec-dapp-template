  ...
  import { BaseMessageSignerWalletAdapter, WalletAccountError, WalletDisconnectionError, WalletName, WalletNotReadyError, WalletPublicKeyError, WalletReadyState, WalletSignMessageError, WalletSignTransactionError, scopePollingDetectionStrategy } from "@solana/wallet-adapter-base";
